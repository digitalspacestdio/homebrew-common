class Vim < Formula
  ...
  url "https://github.com/vim/vim/archive/v8.2.1712.tar.gz"
  sha256 "2386c24bf52c311fc8701813feacda0ccbcba9a84bb21382e470660e0c78183a"
...
#   end
  ...
  ENV['LDFLAGS'] = '-L$(brew --prefix ncurses)/lib'
